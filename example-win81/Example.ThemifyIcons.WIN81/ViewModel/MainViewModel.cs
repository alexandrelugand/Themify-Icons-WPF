...
using Example.ThemifyIcons.WIN81.Annotations;
using ThemifyIcons.WIN81;

namespace Example.ThemifyIcons.WIN81.ViewModel
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        {
            var memberInfo = typeof(ThemifyIconsIcon).GetTypeInfo().GetDeclaredField(icon.ToString());
