...
namespace ThemifyIcons.UWP
{
    ...
    /// <summary>
    /// Represents the category of a themifyicons icon.
    /// </summary>
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true, Inherited = false)]
        ...
        : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ThemifyIcons.UWP.IconCategoryAttribute class.
        /// </summary>
        ...
        : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ThemifyIcons.UWP.IconIdAttribute class.
        /// </summary>
